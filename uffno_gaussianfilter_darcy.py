...
for ep in range(epochs):
    ...
    # with open('/mnt/68213B282F65B10C/LiuH/code/u-shape/uffno_filter/result/darcy/零样本超分辨率/darcy_421_421.txt', 'a') as file:
    #     print('Epoch-{}, Time-{}, Train-Mse-{},Train-L2-{}, Test-L2-{}, Best-Test-L2-{}'
    ...
    #     plt.savefig('/mnt/68213B282F65B10C/LiuH/code/u-shape/uffno_filter/result/darcy/零样本超分辨率/darcy_421_421_{}.png'.format(ep+1))
    #     plt.show()
